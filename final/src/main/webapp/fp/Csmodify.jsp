            ...
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block" >
          	 <img src="images/AHDD2.jpg" alt="" width="550px" height="300px" />
                ...
                <li><a href="Cslist">Services</a></li>
...
<form action="Csmodify" method="post">
	<table class="table">
		...
		<tr style="color: white;">
			...
			<input style="background-color: black;" class="btn btn-outline-white py-2 px-4" type="submit" value="수정" />
			<a href="Cslist"><input style="background-color: black;" class="btn btn-outline-white py-2 px-4" type="button" value="목록" /></a>
			</td>
			</tr>
		</table>
		</form>
