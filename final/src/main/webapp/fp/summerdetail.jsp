   ...
   <div>
      ...
      <div style="text-align: center;"></div>
         <span style="font-size: 18pt;">
            ...
            <p>강원도 양양에 위치한 서피보드를 소개합니다.<br>
여름철 무더운 날씨에는 역시, 서울과 가까운 속초와 강릉, 동해바다를 많이 찾게 되네요.<br>
</p>
         </span>
      </div>
   </div>
    <div>
      ...
      <div style="text-align: center;"></div>
         <span style="font-size: 18pt;">
            ...
            <p>'서퍼들의 천국이라고 불리는 서피비치와 인구해변에 위치한 쏠티캐빈과 파타고니아 등 인스타 핫플들을 들려보았어요.<br /></p>
         </span>
      </div>
   </div>
    <div>
      ...
      <div style="text-align: center;"></div>
         <span style="font-size: 18pt;">
           <strong><img src="images/90f89393e4db4f5d8c9dda97ef5ffd2b.jpg" alt="" width="750" height="500" /></strong>
            <p>
양양 서피비치 앞에는 다들 길가에 주차를 해놓고 들어가시더라구요. 사실, 주변에 정말 아무것도 없어서 <br />서핑만 즐기거나 카페와 펍을 즐기는게 전부이긴 하지만, <br />동남아 감성을 느끼기에 충분한 공간이어서인지, 너무 좋았네요.
</p>
         </span>
      </div>
   </div>
    ...
    <div>
      ...
      <div style="text-align: center;"></div>
         <span style="font-size: 18pt;">
            <strong><img src="images/c8f01f0f-1d54-4bc2-9e36-de389bf6bc49.jpg" alt="" width="750" height="500" /></strong>
            <p>
동해바다이기에 바다를 등진 낙조를 보며 돌아왔답니다. 주변에 죽도해변과 함께 양양두둥실도 위치해 있었지만, <br />그곳도 문을 열지 않아서 양양은 저랑 안맞는듯 했어요.
<br>
</p>
         </span>
      </div>
