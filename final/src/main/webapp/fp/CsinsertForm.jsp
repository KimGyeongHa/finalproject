				...
				<div class="col-md-7" >
					<div class="row mb-5">
						<div class="col-12" align="center">
							<div class="col-6 col-xl-2" data-aos="fade-down">
							<form method="post" action="CsinsertForm?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
							<table>
							...
							<tr style="color: white;">
								<th></th>
								<td align="center"><input type="text" name="cstitle" /></td>
							</tr>
							
							<tr style="color: white;" align="center">								
								<th style="width: 50px;">내용</th>
								<td style="margin-right: 0px;"><textarea name="cscontents" id="" cols="30" rows="8"></textarea></td>
							</tr>
							
						
							<tr style="color: white;">
								<th></th>
								<td>이미지첨부<input class="btn btn-outline-white py-2 px-4" type="file" name="file" id="" /></td>
							...
							<tr style="color: white;">
								<td colspan="2" align="center" >
									<a href="/Cslist" class="btn btn-outline-white py-2 px-4">목록</a>
